# Perfiles — Resumen del microservicio

## Propósito

administra los datos y la lógica del dominio de Perfiles del caso caso02 (TalentoYa).

## Contexto

- **Caso**: caso02 — TalentoYa (App de busqueda de empleo (trabajadores/freelance))
