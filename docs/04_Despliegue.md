# Perfiles — Despliegue y operación
...
| API base | `/api/perfiles` |

## Docker

```bash
docker build -t duoc/jv0101-caso02-perfiles:1.0.0 .
docker run -p 8080:8080 duoc/jv0101-caso02-perfiles:1.0.0
```
