...
public class PerfilSteps {
    ...
    private Long id;
    private ResponseEntity<Perfil> respuesta;
    private ResponseEntity<Void> respuestaVoid;

    private String url() {
        return "http://localhost:" + port + "/api/perfiles";
    }
    ...
    public void servicioDisponible(String servicio) {
        ResponseEntity<Perfil[]> listado = rest.getForEntity(url(), Perfil[].class);
    ...
    public void crearRecurso(String recurso, String nombre) {
        ResponseEntity<Perfil> creado = rest.postForEntity(
                url(), body(nombre), Perfil.class);
    ...
    public void consultarCreado(String recurso) {
        respuesta = rest.getForEntity(url() + "/" + id, Perfil.class);
    }
    ...
    public void actualizar(String recurso, String nombre) {
        respuesta = rest.exchange(url() + "/" + id, HttpMethod.PUT, body(nombre), Perfil.class);
    }
    ...
    public void consultarEliminado(String recurso, int codigo) {
        ResponseEntity<Perfil> noExiste = rest.getForEntity(url() + "/" + id, Perfil.class);
